...
If you have a large old prototype, follow this [guide to backward compatibility](/backwards-compatibility) which lets you update the Prototype Kit without having to rewrite all your pages at once.
